...
const sv: Dict = {
  ...
  // Kort nog för bottennavigationens etikett — vyn heter fortfarande
  // aktivitetsrapport i rubrik och texter.
  'tab.rapport': 'Rapport',
  ...
  'apply.sendWithCv': 'Skicka ansökan med CV',
  'apply.sendConfirm':
    'Skickas till {email} med {fileName} bifogat. Arbetsgivarens svar går till {reply}, och du får en kopia i din mejl.',
  'apply.sendNow': 'Skicka nu',
  'apply.sendCancel': 'Avbryt',
  'apply.sending': 'Skickar…',
  'apply.cvAuto': 'Ditt CV ({fileName}) bifogas automatiskt när du skickar.',
  'notice.sentLogged': 'Ansökan skickad med CV och loggad.',
  ...
  'apply.forReport': 'Till aktivitetsrapporten',
...
const ar: Dict = {
  ...
  'tab.jobb': 'الوظائف',
  // Kort nog för bottennavigationen — vyns rubrik säger fortfarande
  // 'الملف الشخصي'.
  'tab.profil': 'ملفي',
  ...
  'apply.sendWithCv': 'أرسل الطلب مع السيرة الذاتية',
  'apply.sendConfirm':
    'سيُرسل إلى {email} مع إرفاق {fileName}. يصل رد صاحب العمل إلى {reply}، وستصلك نسخة إلى بريدك.',
  'apply.sendNow': 'أرسل الآن',
  'apply.sendCancel': 'إلغاء',
  'apply.sending': 'جارٍ الإرسال…',
  'apply.cvAuto': 'سيرتك الذاتية ({fileName}) تُرفق تلقائيًا عند الإرسال.',
  'notice.sentLogged': 'أُرسل الطلب مع السيرة الذاتية وسُجّل.',
...
const so: Dict = {
  ...
  'apply.sendWithCv': 'Dir codsiga oo CV-gu ku lifaaqan yahay',
  'apply.sendConfirm':
    'Waxaa loo dirayaa {email} iyadoo {fileName} ku lifaaqan yahay. Jawaabta shaqo-bixiyuhu waxay tagtaa {reply}, adigana nuqul ayaa kuugu imanaya emailkaaga.',
  'apply.sendNow': 'Hadda dir',
  'apply.sendCancel': 'Jooji',
  'apply.sending': 'Waa la dirayaa…',
  'apply.cvAuto': 'CV-gaaga ({fileName}) si toos ah ayaa loogu lifaaqayaa marka aad dirto.',
  'notice.sentLogged': 'Codsiga waa la diray oo CV-gu ku lifaaqan yahay, waana la diiwaangeliyay.',
  ...
  'apply.forReport': 'Loogu talagalay warbixinta dhaqdhaqaaqa',
